...
|---|---|---|---|
| 2026-09-05 | `2026-09-05-idea-scout` | сдано | Локальный парсер идей мини-продуктов (пять MVP-источников без ключей + условный X через Apify) с проверкой доверия к метрикам, скорингом по четырём осям, дашбордом на русском и генератором рабочего проекта под Claude Code/Codex/OpenCode — принято 2026-09-11, final acceptance V1 |
